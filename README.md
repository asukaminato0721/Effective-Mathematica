...
0. 前言
1. [学会使用 `F1`(By MMA 吧主)](https://note.youdao.com/ynoteshare1/index.html?id=abd51087f44c0b6a41ff6022d549dc41&type=note)
2. [少用 `For`, 多用 `Nest(List)`, `Fold(List)`, `Do`,`Table`(By MMA 吧主)](https://note.youdao.com/ynoteshare1/index.html?id=7334ad886b97de3565d59beea50b5350&type=note)
3. 列表不宜嵌套过深
...
7. 用 `//` `/*` `@*` 等函数解决嵌套问题
8. 尽量列表整体运算
9. [避免使用下标(By MMA 吧主)](https://note.youdao.com/ynoteshare1/index.html?id=dd90460ca2083dffb8c19078e900a815&type=note)
10. [中途计算避免使用 `MatrixForm`(By MMA 吧主)](https://note.youdao.com/ynoteshare1/index.html?id=d0a57819857f2771ca669eb54819e3d1&type=note)
